(function ($) {
    ...
    // Close mobile menu pressing Escape key
    window.addEventListener('keydown', function (e) {
        if (e.key == 'Escape') {
            if (document.querySelector('.cross-btn').classList.contains('h-active')) {
                document.querySelector('.main-nav').classList.remove('slidenav');
                document.querySelector('.cross-btn').classList.remove('h-active');
            }
        }
